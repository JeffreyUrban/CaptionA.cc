...
1. Creates `captionacc_prod`, `captionacc_staging`, `captionacc_prefect`, and `umami` schemas
...
- Each schema has its own sequences (e.g., `captionacc_prod.video_search_index_id_seq`)
