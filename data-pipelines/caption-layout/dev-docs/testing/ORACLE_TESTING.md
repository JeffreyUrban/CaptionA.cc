...
This document describes the enhanced oracle-based testing framework for caption-layout. The oracle provides ground truth for validating the correctness of the optimized implementation.
...
# With coverage
pytest tests/test_comprehensive.py --cov=caption-layout --cov-report=html
```
