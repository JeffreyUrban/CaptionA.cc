...
`caption-layout` is a TEMPLATE_PLACEHOLDER.
...
```
src/caption-layout/
    caption-layout.py    # Core algorithm (CaptionLayout class)
...
- `caption-layout.py`: Pure Python logic, no CLI dependencies
...
### Core Module: src/caption-layout/caption-layout.py
...
### CLI Module: src/caption-layout/cli.py
...
**Why caption-layout is different**: TEMPLATE_PLACEHOLDER

---

## API for Embedding

The `CaptionLayout` class can be used in other Python applications:

```python
from caption-layout.caption-layout import CaptionLayout
import sys

# Create caption-layout
processor = CaptionLayout(TEMPLATE_PLACEHOLDER)
```
