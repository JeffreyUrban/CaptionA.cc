...
# Contributing to caption-layout

Thank you for your interest in contributing to caption-layout! This guide will help you get started.
...
**Command used**:
```bash
caption-layout --TEMPLATE_PLACEHOLDER
```
...
**Environment**:
- caption-layout version: `caption-layout --version`
...
def test_TEMPLATE_PLACEHOLDER():
    ...
    TEMPLATE_PLACEHOLDER = CaptionLayout(TEMPLATE_PLACEHOLDER)
...
```
caption-layout/
├── src/caption-layout/          # Source code
│   ├── __init__.py
...
```bash
# Time a command
time caption-layout large-file.log > /dev/null

# Profile with cProfile
python -m cProfile -s cumulative -m caption-layout large-file.log
```
...
1. **Add to CLI** (`src/caption-layout/cli.py`):
   ```python
   @app.command()
   def main(
       # ... existing options ...
...
2. **Add to core** (`src/caption-layout/TEMPLATE_PLACEHOLDER.py`):
   ```python
...
3. **Add tests**:
   ```python
   def test_my_option():
       dedup = CaptionLayout(my_option=50)
       # Test behavior
   ```
...
def test_new_feature():
    ...
    TEMPLATE_PLACEHOLDER = CaptionLayout(new_option=True)
    # Test code
EOF
...
- **Documentation**: https://github.com/yourusername/caption-layout/docs
- **Issue Tracker**: https://github.com/yourusername/caption-layout/issues
- **Discussions**: https://github.com/yourusername/caption-layout/discussions
...
By contributing to caption-layout, you agree that your contributions will be licensed under the MIT License.
...
Thank you for contributing to caption-layout! 🎉
