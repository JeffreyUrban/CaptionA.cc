...
API reference for the `CaptionLayout` class - the core TEMPLATE_PLACEHOLDER.

## Overview

The `CaptionLayout` class provides the core TEMPLATE_PLACEHOLDER.
...
::: caption_layout.caption_layout.CaptionLayout
    options:
      show_source: false
