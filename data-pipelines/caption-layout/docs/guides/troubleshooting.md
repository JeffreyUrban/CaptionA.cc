...
**Symptom**: caption-layout TEMPLATE_PLACEHOLDER
...
5. **Statistics**:
   ```bash
   caption-layout your-file.log --stats-format json 2>&1
   ```

### Where to Get Help

- **GitHub Issues**: https://github.com/crate-ci/caption-layout/issues
- **Documentation**: https://docs.rs/caption-layout
