...
Quick reference for common caption-layout use cases and patterns. Each pattern includes copy-paste ready commands.

## Pattern Reference

| Pattern  | Command               | Use Case |
|----------|-----------------------|----------|
| **TEMPLATE_PLACEHOLDER** | `caption-layout --TEMPLATE_PLACEHOLDER` | TEMPLATE_PLACEHOLDER     |
