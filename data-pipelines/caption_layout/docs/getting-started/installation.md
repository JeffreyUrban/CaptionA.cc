...
```bash
brew tap jeffreyurban/caption_layout
...
```bash
echo -e "TEMPLATE_PLACEHOLDER" | caption_layout --TEMPLATE_PLACEHOLDER
```
...
```bash
brew upgrade caption_layout
```

### pipx

```bash
pipx upgrade caption_layout
```

### pip

```bash
pip install --upgrade caption_layout
```
...
```bash
brew uninstall caption_layout
```

### pipx

```bash
pipx uninstall caption_layout
```

### pip

```bash
pip uninstall caption_layout
```
