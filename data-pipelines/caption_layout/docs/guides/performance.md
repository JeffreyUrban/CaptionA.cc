...
Understand caption-layout's performance characteristics and optimize for your use case.
...
# Benchmark
time caption_layout test.log --TEMPLATE_PLACEHOLDER > /dev/null
```
...
caption-layout uses TEMPLATE_PLACEHOLDER memory regardless of TEMPLATE_PLACEHOLDER:
...
- [Algorithm Details](../about/algorithm.md) - How caption-layout works internally
