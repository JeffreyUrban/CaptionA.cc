...
caption_layout large.log --explain --progress 2>&1 | tee diagnostics.txt
```
...
caption_layout log.txt --explain 2>&1 | grep "TEMPLATE_PLACEHOLDER"
```
...
caption_layout log.txt --explain > clean.log

# Both to separate files
caption_layout log.txt --explain > clean.log 2> explain.log

# Merge for analysis
caption_layout log.txt --explain 2>&1 | grep "Line 42"
```
