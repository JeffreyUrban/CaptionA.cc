#!/bin/bash
# Quick setup script for Modal caption frame extents inference service
#
# Usage:
...
echo "🚀 Modal Caption Frame Extents Inference Setup"
echo "=================================="
echo ""
...
echo "     SUPABASE_SCHEMA=captionacc_prod"
echo ""
echo "2. Upload model checkpoint:"
echo "   python scripts/upload_model_to_modal.py \\"
echo "     --checkpoint local/models/caption_frame_extents/fusion_lora_spatial_mrn0fkfd.pt \\"
echo "     --model-version mrn0fkfd"
echo ""
echo "3. Deploy inference service:"
echo "   modal deploy src/caption_frame_extents/inference/service.py"
echo ""
echo "4. Test inference:"
echo "   modal run src/caption_frame_extents/inference/service.py::test_inference"
echo ""
