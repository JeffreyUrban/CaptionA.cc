...
Usage:
    ...
    python scripts/upload_model_to_modal.py \
        ...
        --model-version v2 \
        --volume caption-frame-extents-models-dev
"""
...
volume = modal.Volume.from_name("caption-frame-extents-models", create_if_missing=True)
...
def main():
    ...
    parser.add_argument(
        "--volume",
        default="caption-frame-extents-models",
        help="Modal volume name (default: caption-frame-extents-models)",
    )
    parser.add_argument(
        "--force",
        action="store_true",
