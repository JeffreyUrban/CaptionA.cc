"""Modal inference service for caption frame extents detection.
...
from caption_frame_extents.inference.config import MODAL_CONFIG
...
# Modal app
if modal:
    app = modal.App("caption-frame-extents-inference")
    ...
    image = (
        ...
        # Add local caption_frame_extents package to the image
...
def run_caption_frame_extents_inference_batch(
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Step 6: Create caption frame extents database
        print("[6/8] Creating caption frame extents database...")
        db_start = time.time()
        ...
        # Step 7: Upload caption frame extents database to Wasabi
        print("[7/8] Uploading caption frame extents database to Wasabi...")
...
def main():
    ...
    # Run inference
    print("\n[1/2] Running caption frame extents inference...")
    result = run_caption_frame_extents_inference_batch.remote(
        video_id=VIDEO_ID,
        tenant_id=TENANT_ID,
