...
# Import this in application code: `from caption_frame_extents.inference.config import MODAL_CONFIG`
...
def format_frame_count_limit_message(
    ...
    return (
        ...
        f"2. Increase limit in: data-pipelines/caption_frame_extents/src/caption_frame_extents/inference/config.py\n"
