...
caption_frame_extents list-models
...
caption_frame_extents infer video.db --checkpoint best.pt
```
...
```python
# models/__init__.py
from caption_frame_extents.models import my_new_architecture  # noqa: F401
```

**3. Use**
```bash
caption_frame_extents train dataset --architecture my_new_architecture
```
...
```bash
# Standard rank (16)
caption_frame_extents train dataset \
    --architecture channel_fusion_lora_resnet50
...
caption_frame_extents train dataset --name exp1 --architecture triple_backbone_resnet50
caption_frame_extents train dataset --name exp2 --architecture channel_fusion_lora_resnet50
