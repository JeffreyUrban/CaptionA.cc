"""
Test script for sequential crop_and_infer implementation.

This script tests ONLY the sequential crop_and_infer Modal function:
...
4. Runs the sequential crop_and_infer Modal function and displays metrics
...
Run as `python test_sequential.py`
"""
...
def run_sequential_test():
    ...
    # Step 4: Run sequential crop_and_infer
    print("[4/4] Running SEQUENTIAL crop_and_infer_caption_frame_extents...")
    print("=" * 80)
    ...
    try:
        ...
        print("=" * 80)
        print()
        print("✓ Sequential implementation completed successfully!")
        print()
        print("Results:")
