...
class TestBatchBoundaryPredictorInit:
    """Tests for BatchBoundaryPredictor initialization."""
...
class TestBatchBoundaryPredictorSpatialFeatures:
...
class TestBatchBoundaryPredictorPrediction:
...
class TestBatchBoundaryPredictorLabels:
    """Tests for label mapping."""

    def test_labels_match_dataset_labels(self, tmp_path):
        """Labels should match CaptionBoundaryDataset.LABELS."""
        layout_db_path = create_mock_layout_db(tmp_path)
        checkpoint_path = create_mock_checkpoint(tmp_path)
