"""Batch predictor for boundary inference.

Adapted from BoundaryPredictor to work with extracted frames (not database frames).
...
class BatchBoundaryPredictor:
    """Predicts boundaries using trained model with batch inference support.
