"""Supabase repository for boundary inference run tracking.
...
class BoundaryInferenceRunRepository:
    """Repository for boundary inference run tracking in Supabase.
    ...
    Usage:
        ...
        run = repo.register_run(
            ...
            wasabi_storage_key="videos/tenant/video/boundaries/v1_model-abc123_run-550e8400.db",
    ...
    def get_existing_run(
        ...
        """
        response = (
            self.client.table("boundary_inference_runs")
            .select("*")
    ...
    def register_run(
        ...
        Args:
            ...
            cropped_frames_version: Frame version number
            model_version: Model checkpoint hash
            wasabi_storage_key: Full Wasabi path to boundaries DB
        ...
        response = self.client.table("boundary_inference_runs").insert(data).execute()
    ...
    def create_job(
        ...
        response = self.client.table("boundary_inference_jobs").insert(data).execute()
