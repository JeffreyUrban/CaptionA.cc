...
`full-frames` is a TEMPLATE_PLACEHOLDER.
...
```
src/full-frames/
    full-frames.py    # Core algorithm (CaptionLayout class)
...
- `full-frames.py`: Pure Python logic, no CLI dependencies
...
### Core Module: src/full-frames/full-frames.py
...
### CLI Module: src/full-frames/cli.py
...
**Why full-frames is different**: TEMPLATE_PLACEHOLDER
...
```python
from full-frames.full-frames import CaptionLayout
import sys
