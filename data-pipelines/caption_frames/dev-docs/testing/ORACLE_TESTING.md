...
This document describes the enhanced oracle-based testing framework for caption_frames. The oracle provides ground truth for validating the correctness of the optimized implementation.
...
# With coverage
pytest tests/test_comprehensive.py --cov=caption_frames --cov-report=html
```
