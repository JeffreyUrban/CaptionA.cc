"""Performance benchmark for Caption Frame Extents Annotation page frame loading.
...
class TestCaptionFrameExtentsAnnotationPerformance:
    """Performance tests simulating Caption Frame Extents Annotation page."""
