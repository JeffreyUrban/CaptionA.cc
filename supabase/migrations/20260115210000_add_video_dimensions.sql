...
COMMENT ON COLUMN captionacc_production.videos.width IS 'Video width in pixels (0 if unknown)';
COMMENT ON COLUMN captionacc_production.videos.height IS 'Video height in pixels (0 if unknown)';
