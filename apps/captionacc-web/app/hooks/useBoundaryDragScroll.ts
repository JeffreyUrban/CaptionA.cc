...
interface UseBoundaryDragScrollParams {
  currentFrameIndex: number
  totalFrames: number
  onFrameChange: (newFrame: number) => void
}

interface UseBoundaryDragScrollReturn {
 ...
 */
export function useBoundaryDragScroll({
  currentFrameIndex,
  totalFrames,
  onFrameChange,
}: UseBoundaryDragScrollParams): UseBoundaryDragScrollReturn {
