 ...
 * This is the single source of renders for the caption frame extents workflow.
 *
...
import {
  ...
  type Annotation,
  type CaptionFrameExtentsDisplayState,
  type Frame,
} from '~/types/caption-frame-extents'
 ...
 */
export interface CaptionFrameExtentsRefs {
...
interface UseCaptionFrameExtentsDisplaySyncParams {
  refs: CaptionFrameExtentsRefs
}

interface UseCaptionFrameExtentsDisplaySyncReturn {
 ...
 */
export function useCaptionFrameExtentsDisplaySync({
  refs,
}: UseCaptionFrameExtentsDisplaySyncParams): UseCaptionFrameExtentsDisplaySyncReturn {
  const [displayState, setDisplayState] =
    useState<CaptionFrameExtentsDisplayState>(INITIAL_DISPLAY_STATE)
