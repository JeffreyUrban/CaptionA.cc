interface CaptionFrameExtentsHelpModalProps {
  isOpen: boolean
  onClose: () => void
}

export function CaptionFrameExtentsHelpModal({
  isOpen,
  onClose,
}: CaptionFrameExtentsHelpModalProps) {
      ...
      >
        ...
        <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
          <section>
            ...
            <p>
              This page helps you review and correct caption frame extents for video content. Each
              annotation is either a single caption&apos;s range or a single non-caption range
              between captions.
            </p>
            <p className="mt-2">
              <strong>Important:</strong> The caption frame extents should include both the start
              and end frames of the range, as shown by the colored border around the frames.
            </p>
          </section>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-md border-l-2 border-indigo-500 bg-indigo-50 p-3 dark:bg-indigo-950">
                ...
                <p className="mt-1 text-indigo-800 dark:text-indigo-300">
                  Machine learning predictions for caption frame extents (captions or non-caption
              ...
              <div className="rounded-md border-l-2 border-teal-500 bg-teal-50 p-3 dark:bg-teal-950">
                ...
                <p className="mt-1 text-teal-800 dark:text-teal-300">
                  Human-verified annotations with correct caption frame extents for either captions
                  or non-caption content. These are considered complete and accurate.
                </p>
              </div>
          ...
          <section>
            ...
            <ol className="list-decimal space-y-2 pl-5">
              ...
              <li>
                Adjust caption frame extents using Mark Start/End buttons or (left, right) mouse
                clicks
              </li>
              <li>
              ...
              <li>
                Use &ldquo;Clear Marks&rdquo; to reset to original caption frame extents if needed
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc space-y-2 pl-5">
              <li>Caption frame extents must include both start and end frames (inclusive)</li>
