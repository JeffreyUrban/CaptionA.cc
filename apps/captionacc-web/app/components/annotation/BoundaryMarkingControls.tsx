interface BoundaryMarkingControlsProps {
...
export function BoundaryMarkingControls({
  markedStart,
  markedEnd,
  hasActiveAnnotation,
  onJumpToStart,
  ...
  onMarkEnd,
  onClearMarks,
}: BoundaryMarkingControlsProps) {
  return (
    <div>
      <div className="mb-2 text-sm font-semibold text-gray-700 dark:text-gray-300">Boundaries</div>
