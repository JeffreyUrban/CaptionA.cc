"""SQLModel table definitions for boundaries inference database."""
...
class BoundariesRunMetadata(SQLModel, table=True):
    """Metadata for a boundaries inference run (single-row per database file)."""
