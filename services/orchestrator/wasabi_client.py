...
class WasabiClient:
    ...
    def __init__(
        ...
        """
        self.access_key = access_key or os.environ.get("WASABI_ACCESS_KEY_READWRITE") or os.environ.get("WASABI_ACCESS_KEY")
        self.secret_key = secret_key or os.environ.get("WASABI_SECRET_KEY_READWRITE") or os.environ.get("WASABI_SECRET_KEY")
